...
import me.tbsten.tripleTriad.ui.designSystem.components.AlertDialogDefaults.DialogMaxWidth
import me.tbsten.tripleTriad.ui.designSystem.components.AlertDialogDefaults.DialogMinWidth
...
fun AlertDialog(
    ...
    containerColor: Color = TripleTriadTheme.colors.surface,
    iconContentColor: Color = TripleTriadTheme.colors.primary,
    titleContentColor: Color = TripleTriadTheme.colors.primary,
    textContentColor: Color = TripleTriadTheme.colors.primary,
        ...
        Column(modifier = Modifier.padding(DialogPadding)) {
            ...
            title?.let {
                ProvideContentColorTextStyle(
                    ...
                    textStyle = TripleTriadTheme.typography.h3,
                ) {
                    Box(
                        Modifier
            ...
            text?.let {
                val textStyle = TripleTriadTheme.typography.body1
                ProvideContentColorTextStyle(
            ...
            Box(modifier = Modifier.align(Alignment.End)) {
                val textStyle = TripleTriadTheme.typography.body2
                ProvideContentColorTextStyle(
