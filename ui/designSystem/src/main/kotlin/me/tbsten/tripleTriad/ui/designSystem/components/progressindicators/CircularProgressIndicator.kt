package me.tbsten.tripleTriad.ui.designSystem.components.progressindicators
...
object CircularProgressIndicatorDefaults {
    val Color: Color
        @Composable get() = TripleTriadTheme.colors.primary

    val TrackColor: Color
        @Composable get() = TripleTriadTheme.colors.transparent
...
fun CircularProgressIndicatorPreview() {
    TripleTriadTheme {
        Column(
            ...
            BasicText(text = "Determinate Progress", style = TripleTriadTheme.typography.body1)
            CircularProgressIndicator(progress = 0.7f)

            BasicText(text = "Indeterminate Progress", style = TripleTriadTheme.typography.body1)
