...
internal object TextFieldDefaults {
    ...
    fun colors(): TextFieldColors = TextFieldColors(
        ...
        focusedContainerColor = TripleTriadTheme.colors.surface,
        unfocusedContainerColor = TripleTriadTheme.colors.surface,
        disabledContainerColor = TripleTriadTheme.colors.disabled,
        errorContainerColor = TripleTriadTheme.colors.surface,
        cursorColor = TripleTriadTheme.colors.primary,
        errorCursorColor = TripleTriadTheme.colors.error,
        textSelectionColors = LocalTextSelectionColors.current,
        focusedOutlineColor = TripleTriadTheme.colors.transparent,
        unfocusedOutlineColor = TripleTriadTheme.colors.transparent,
        disabledOutlineColor = TripleTriadTheme.colors.transparent,
