package me.tbsten.tripleTriad.ui.designSystem.components.textfield.base
...
internal fun CommonDecorationBox(
    ...
    TextFieldTransitionScope.Transition(
        ...
        val decoratedLabel: @Composable (() -> Unit)? =
            label?.let {
                @Composable {
                    Decoration(labelColor, TripleTriadTheme.typography.label1, it)
                }
            }
                ...
                @Composable { modifier ->
                    Box(modifier.alpha(placeholderAlphaProgress)) {
                        Decoration(
                            ...
                            typography = TripleTriadTheme.typography.input,
                            content = placeholder,
                        )
                    }
                }
